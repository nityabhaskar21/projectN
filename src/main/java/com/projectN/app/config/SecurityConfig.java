...
//	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.antMatchers(HttpMethod.GET, "/users/username/{username}").hasAnyRole("USER", "SUPER_USER", "DEVELOPER", "ADMIN")
			.antMatchers(HttpMethod.GET, "/users/id/{id}").hasAnyRole("USER", "SUPER_USER", "DEVELOPER", "ADMIN")
			...
			.antMatchers(HttpMethod.PUT, "/users/username/{username}").hasAnyRole("USER", "SUPER_USER", "DEVELOPER", "ADMIN")
			.antMatchers(HttpMethod.PUT, "/users/id/{id}").hasAnyRole("USER", "SUPER_USER", "DEVELOPER", "ADMIN")
